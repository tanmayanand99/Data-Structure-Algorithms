...
void findtriplet(node *head)
{
    node *front=NULL,*last=NULL,*front1=NULL;
    int sum,n;
    front1=head;
    front=head;
    last=head;
    ...
    while(front1!=NULL)
    {
        ...
        while(front!=NULL)
        {
            ...
            while(last!=NULL)
            {
                if(front1->data+front->data+last->data==sum)
                {
                    cout << "(" << front1->data << "," << front->data << "," << last->data << ")" << endl;
                }
                last=last->next;
            }
            front=front->next;
